...
cli: hash_table self_balancing_binary_tree

LIBRARIES = hash_table self_balancing_binary_tree

EXECUTABLES = cli

TEST_EXECUTABLES = $(addsuffix _test,$(filter-out kvstore,$(LIBRARIES)))

PROJECTS = $(LIBRARIES) $(EXECUTABLES)

TARGETS = $(EXECUTABLES) $(LIBRARIES:%=%.a)
